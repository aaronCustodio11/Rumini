...
import 'package:rumini/utils(emo)/pdf_downloader.dart';
...
class Calendaremotion extends StatefulWidget {
  final Map<String, dynamic> userData;
  const Calendaremotion({super.key, required this.userData});

  @override
  _CalendaremotionState createState() => _CalendaremotionState();
}

class _CalendaremotionState extends State<Calendaremotion> {
...
String? _filteredMonthName;
  ...
  Map<String, Color> emotionColors = {
    'Joy': const Color(0xFFE3AB2F),
    'Sad': const Color(0xFF2F5FA7),
    'Surprise': const Color(0xFF3DA3A3),
    'Fear': const Color(0xFF563A88),
    'Disgusted': const Color(0xFF4C913B),
    'Contempt': const Color(0xFFB16645),
    'Angry': const Color(0xFFA2352D),
  };
  ...
  void initState() {
    super.initState();
    _fetchEmotionLogs();
    _fetchEmotionColorMappings();
    _saveLastVisited("Calendaremotion");
  }
  ...
  Future<void> _fetchEmotionColorMappings() async {
    try {
      ...
      print('Error fetching emotion colors: $e');
    }
  }
  ...
  Future<void> _fetchEmotionLogs() async {
    ...
    setState(() {
      ...
      for (var doc in snapshot.docs) {
        ...
        Color color = Color(int.parse(doc['color'], radix: 16) + 0xFF000000);
        loggedColors.putIfAbsent(dateString, () => []).add(color);
      }
  ...
  // 🌈 Improved Emotion Legend (modern card style)
  void _showEmotionLegendDialog() {
  showDialog(
    context: context,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Sub info
              const Text(
                "Each emotion is represented by a color below.\nWhen multiple emotions are logged on the same day, their colors blend together to show a gradient mix.",
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontSize: 14.5,
 ...
 Future<void> _showMonthFilterDialog(BuildContext context) async {
            ...
            actions: [
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  ...
                  setState(() {
                    if (selectedMonth == "Show All") {
                      // ✅ Reset to show all months
                      _isFiltered = false;
                      _filteredMonthName = null;
                      _fetchEmotionLogs();
                    } else if (selectedMonth != null) {
                      _filteredMonthName = selectedMonth!;
                      _isFiltered = true;
                      months = months
                          .where((m) =>
  ...
  for (int i = 1; i <= daysInMonth; i++) {
    String dateString =
        DateFormat('yyyy-MM-dd').format(DateTime(month.year, month.month, i));
    List<Color>? colors = loggedColors[dateString];
    bool isToday =
        (now.year == month.year && now.month == month.month && now.day == i);
  ...
  decoration = decoration.copyWith(
    ...
    Widget cell = GestureDetector(
      ...
      child: Container(
        ...
        margin: const EdgeInsets.all(2), // ✅ tighter gap between cells
      ...
      child: Column(
        children: [
          ...
          GridView.count(
            ...
            childAspectRatio:
                1.0, // ✅ square shape for larger, fuller cells
            children: dayWidgets,
          ),
        ],
      ),
...
Widget build(BuildContext context) {
  ...
  return Scaffold(
    backgroundColor: const Color.fromARGB(255, 232, 232, 232), // ✅ Main background
    appBar: AppBar(
  elevation: 0,
  ...
  title: Row(
    ...
    children: [
      ...
      OutlinedButton.icon(
        ...
        onPressed: _showEmotionLegendDialog,
      ),
    ],
  ),
  centerTitle: false,
    ...
    body: SingleChildScrollView(
      child: Column(
        children: [
          ...months.map((month) => _buildCalendar(month)).toList(),
        ],
      ),
    ),

    // ✅ Modern collapsible Floating Action Button (Speed Dial)
    floatingActionButton: SpeedDial(
      animatedIcon: AnimatedIcons.menu_close,
      backgroundColor: const Color(0xFF4CAF50), // ✅ Calm green tone
      ...
      children: [
        ...
        SpeedDialChild(
          ...
          backgroundColor: const Color(0xFF009688), // ✅ Teal accent
          label: "Switch View",
          labelStyle: const TextStyle(fontWeight: FontWeight.w600),
          onTap: () {
            _navigateWithSlideAnimation(
              context,
              Calendarmood(userData: widget.userData),
            );
          },
        ),
        ...
        SpeedDialChild(
          ...
          backgroundColor: const Color(0xFFF57C00), // ✅ Muted orange
          label: "Export as PDF",
          labelStyle: const TextStyle(fontWeight: FontWeight.w600),
      ...
      builder: (BuildContext context) {
        return StatefulBuilder(
          builder: (context, setState) {
            ...
            return AlertDialog(
              title: Text("Convert Emotion Logs"),
              content: Column(
                mainAxisSize: MainAxisSize.min,
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              ...
              // Create a table for the emotion legend
              pw.Wrap(
                spacing: 10,
                runSpacing: 10,
                children: emotionColors.entries.map((entry) {
                      ...
                      children: [
                        pw.Container(
                          ...
                          decoration: pw.BoxDecoration(
                            color: _pdfColorFromColor(entry.value),
  ...
  PdfColor _pdfColorFromColor(Color color) {
    return PdfColor(
      color.red / 255,
      color.green / 255,
      color.blue / 255,
